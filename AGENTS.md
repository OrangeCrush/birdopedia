...
The index page:
Alphabetically sorted links to all of the birds in the project.  Also gives some information about the collection

The bird pages.  A template will be used to generate these static pages.
The bird pages should detail information about the species.  This information should be pulled from ebird.  Also, metadata from the image should be used such as latitude / longitude, capture date, and camera equipment. Include as much information about the image as possible, since the intention is to showcase the photography as much as the bird.  All images can be displayed on the page as a carasol.  The image should be prominently placed such that it grabs users attention.
